	...
	<html>
		...
		<?php
			...
			if($a){
				...
				$sql = "INSERT INTO seatsSold VALUES (NULL, \"" . $_POST["firstName"] . "\", \"" . $_POST["lastName"] . "\", \"" . $_POST["email"] . "\", \"" . $_POST["phone"] . "\", \"" . $_POST["street"] . "\", \"" . $_POST["city"] . "\", \"" . $_POST["state"] . "\", \"" . $_POST["zip"] . "\", \"" . $_POST["adult"] . "\", \"" . $_POST["student"] . "\", \"" . $_POST["golden"] . "\", \"" . $_POST["showSelected"] . "\", \"" . $_POST["selectedSeats"] . "\", \"" . "0" . "\", \"" . date("Y-m-d H:i:s") . "\", \"" . $_SERVER['REMOTE_ADDR'] . "\");";
				...
				$sql = "INSERT INTO seatsSold_backup VALUES (" . $row["ID"] . ", \"" . $_POST["firstName"] . "\", \"" . $_POST["lastName"] . "\", \"" . $_POST["email"] . "\", \"" . $_POST["phone"] . "\", \"" . $_POST["street"] . "\", \"" . $_POST["city"] . "\", \"" . $_POST["state"] . "\", \"" . $_POST["zip"] . "\", \"" . $_POST["adult"] . "\", \"" . $_POST["student"] . "\", \"" . $_POST["golden"] . "\", \"" . $_POST["showSelected"] . "\", \"" . $_POST["selectedSeats"] . "\", \"" . "0" . "\", \"" . date("Y-m-d H:i:s") . "\", \"" . $_SERVER['REMOTE_ADDR'] . "\");";
				mysqli_query($conn, $sql);
