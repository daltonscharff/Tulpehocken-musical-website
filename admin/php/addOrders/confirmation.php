		...
		<body style="width: 800px; height: 1000px;">
			...
			<?php 
				if($_SESSION["success"]){
					...
					<?php
						if($_POST['email']){
							echo "<h4 style='margin-top:0px;'>An email has been sent to ". $_POST['email'] . "</h4>";
						}
					?>
					...
					<table>
						...
						<?php
							if($_SESSION["paid"] == 0){
								echo "<tr><td class='rightAlignText' style='border-top: solid black 2px;border-bottom: solid black 2px;'>Amount Due:</td><td class='leftAlignText' style='border-top: solid black 2px;border-bottom: solid black 2px;'><b>$" . $due . "</b></td></tr>";
								echo "<p><b>Please send payment to: </b><br>Tulpehocken Area School District<br>Attention: Dory Triest<br>27 Rehrersburg Road<br>Bethel PA 19507<br><br><b>Make checks payable to:</b><br>Tulpehocken Area School District<br><br><u>Please include your order number with your payment.</u><br>Once we receive your payment we will send the tickets to you if time allows or hold them at the ticket window the night of the show.</p>";
							}
						?>
					</table>
				...
				$to = $_POST["email"];
					...
					if($_SESSION["paid"] == 0){
						...
						$msg .= "Thank you for your payment. If time allows, we will sent you your tickets. Otherwise, they can be picked up at the ticket window on the night of the show.";
					}
